...
public class ConfigurationApi implements io.airbyte.api.V1Api {
  ...
  public ConfigurationApi(final ConfigRepository configRepository,
    ...
    jobHistoryHandler = new JobHistoryHandler(jobPersistence, workerEnvironment, logConfigs, connectionsHandler, sourceHandler, sourceDefinitionsHandler, destinationHandler, destinationDefinitionsHandler, airbyteVersion);
